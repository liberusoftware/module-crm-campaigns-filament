...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-crm-campaigns-filament?sort=semver)](https://github.com/liberusoftware/module-crm-campaigns-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-crm-campaigns-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-crm-campaigns-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-crm-campaigns-filament
```
...
<a href="https://github.com/liberusoftware/module-crm-campaigns-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-crm-campaigns-filament" alt="Contributors to liberusoftware/module-crm-campaigns-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-crm-campaigns-filament/graphs/contributors).
